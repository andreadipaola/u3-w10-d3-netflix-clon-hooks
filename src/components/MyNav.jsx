      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto text-custom-white">
            ...
            <Link
              className={`nav-link ${
                location.pathname === "/tv-shows" ? "fw-bold text-custom-white" : "text-custom-white"
              }`}
              to="/tv-shows"
            >
              TV Shows
          ...
          <div className="d-flex align-items-center my-2">
            ...
            <Dropdown>
              <Dropdown.Toggle id="avatar-btn" variant="outline-custom-white" className="border-0 p-0">
                <img src={avatar} alt="" className="img-fluid rounded wd-32 me-1" />
              </Dropdown.Toggle>
